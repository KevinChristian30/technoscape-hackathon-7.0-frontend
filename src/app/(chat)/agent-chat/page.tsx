                ...
                <main className="grid flex-1 items-start gap-4 p-4 sm:px-0 sm:py-0 md:gap-8">
                    ...
                    <div className="grid gap-4 md:grid-cols-[1fr_250px] lg:grid-cols-3 lg:gap-8">
                        <div className="grid auto-rows-max items-start gap-4 lg:col-span-2 lg:gap-3">
                            <Alert>
                                ...
                                <div className="font-md">
                                    <span className="flex items-center gap-2">
                                        <ChevronRight className="h-4 w-4 text-muted-foreground" /> josafat anderson
                                    </span>
                                </div>
                                <div className="font-md">
                                    <span className="flex items-center gap-2">
                                        <Mail className="h-4 w-4 text-muted-foreground" /> josafatanderson@email.com
                                    </span>
                                </div>
                            </Alert>
                            <Card x-chunk="Page-07-chunk-1 py-2">
                                <CardContent className="py-6 flex flex-col gap-4">
                                    ...
                                    <div className="ml-auto flex items-start gap-2.5">
                                        <div className="flex flex-col w-full max-w-[320px] leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-s-xl rounded-ee-xl dark:bg-gray-700">
                                            <div className="flex items-center space-x-2 rtl:space-x-reverse">
                                                <span className="text-sm font-semibold text-gray-900 dark:text-white">Josafat Anderson Yonain</span>
                                                <span className="text-sm font-normal text-gray-500 dark:text-gray-400">11:46</span>
                                            </div>
                                            <p className="text-sm font-normal py-2.5 text-gray-900 dark:text-white">That{"'"}s awesome. I think our users will really appreciate the improvements.</p>
                                            <span className="text-sm font-normal text-gray-500 dark:text-gray-400">Delivered</span>
                                ...
                                <CardFooter className="justify-between py-4 gap-2">
                                    ...
                                    <Button size="sm" variant="default" className="gap-1 dark:text-white">
                        ...
                        <div className="grid auto-rows-max items-start gap-4 lg:gap-3">
                            ...
                            <Card
                                className="overflow-hidden" x-chunk="Page-07-chunk-4"
                            >
                                <CardHeader>
